 ...
 * 
 */
@WebServiceClient(name = "AutoresService", targetNamespace = "http://ggdio.com.br/estoque/services/AutoresService/v1", wsdlLocation = "file:/C:/eclipse-workspaces/ggdio-soa-aplicado/soa-cap07-contractfirst/src/main/resources/contracts/AutoresService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName AUTORESSERVICE_QNAME = new QName("http://ggdio.com.br/estoque/services/AutoresService/v1", "AutoresService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/eclipse-workspaces/ggdio-soa-aplicado/soa-cap07-contractfirst/src/main/resources/contracts/AutoresService.wsdl");
    ...
    public AutoresService getAutoresServiceSOAP() {
        return super.getPort(new QName("http://ggdio.com.br/estoque/services/AutoresService/v1", "AutoresServiceSOAP"), AutoresService.class);
    }
    ...
    public AutoresService getAutoresServiceSOAP(WebServiceFeature... features) {
        return super.getPort(new QName("http://ggdio.com.br/estoque/services/AutoresService/v1", "AutoresServiceSOAP"), AutoresService.class, features);
    }
