 ...
 * 
 */
@WebServiceClient(name = "ListagemLivrosService", targetNamespace = "http://service.estoque.ggdio.com.br/", wsdlLocation = "http://192.168.1.101:8080/livros?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LISTAGEMLIVROSSERVICE_QNAME = new QName("http://service.estoque.ggdio.com.br/", "ListagemLivrosService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.101:8080/livros?wsdl");
    ...
    public ListagemLivros getListagemLivrosPort() {
        return super.getPort(new QName("http://service.estoque.ggdio.com.br/", "ListagemLivrosPort"), ListagemLivros.class);
    }
    ...
    public ListagemLivros getListagemLivrosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.estoque.ggdio.com.br/", "ListagemLivrosPort"), ListagemLivros.class, features);
    }
